...
Cada arquivo contém 60 quadros em uma grade 8 × 8; as quatro últimas células estão vazias. Os três originais medem 15360 × 8640.
...
Margô está disponível na seleção. O idle roda a 12 fps (ciclo de 5 segundos), tanto no menu quanto na fase; a caminhada acompanha a velocidade; o salto acompanha subida, ápice e queda, seguido pelo pouso. A configuração fica em `src/config/characters.ts`. As colisões seguem as mesmas regras dos outros personagens.
